...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|PUTRI|❤',
    ...
    pages: [
        ...
        { 
            ...
            content: 'first of all, i just wanna say thank you. thank you for being you, for being patient, kind, and always making me feel loved. -wisnu ganteng.' 
        }
    ],
    enableBook: true,
    enableHeart: true,
...
applySettingsButton.addEventListener('click', () => {
    ...
    settings.sequence = document.getElementById('sequenceText').value || 'HAPPY|BIRTHDAY|TO|PUTRI|❤';
